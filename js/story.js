  ...
  },
  {
    ...
    scenes: [
      ...
      },
      {
        id: "mountain_victory",
        title: "النصر",
        text: "صمدت أمام الحصار وبنيت قلعة لا تتزعزع. الآن أصبحت قوة يجب حسابها في الصحراء.",
        icon: "🏰",
    ...
    scenes: [
      {
        id: "epilogue_peace",
        title: "عهد السلام",
        text: "تتوج ملكاً على الصحراء. القبائل تبايعك والطرق آمنة. الأمراء من كل مكان يأتون لتهنئتك. تبدأ في بناء عاصمة جديدة تليق بمملكتك.",
        icon: "🕊️",
